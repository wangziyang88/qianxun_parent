package com.qianxun.framework.web.exception;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult handlerNoFoundException(Exception e)
    {
        ...
        return AjaxResult.error(HttpStatus.NOT_FOUND,MessageUtils.message("path.not.exist"));//路径不存在，请检查路径是否正确
    }
    ...
    public AjaxResult handleAuthorizationException(AccessDeniedException e)
    {
        ...
        return AjaxResult.error(HttpStatus.FORBIDDEN, MessageUtils.message("no.permission"));//没有权限，请联系管理员授权
    }
