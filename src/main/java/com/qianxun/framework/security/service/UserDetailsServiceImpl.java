...
import com.qianxun.common.enums.UserStatus;
...
public class UserDetailsServiceImpl implements UserDetailsService
{
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException
    {
        ...
        if (StringUtils.isNull(user))
        {
            ...
            throw new UsernameNotFoundException(MessageUtils.message("user.not.exists"));//登录用户不存在
        }
        ...
        else if (UserStatus.DISABLE.getCode().equals(user.getStatus()))
        {
            ...
            throw new BaseException(MessageUtils.message("user.is.deactivate",username));//对不起，您的账号：" + username + " 已停用
        }
